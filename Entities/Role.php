...
class Role extends Model {
    ...
    {
        return $this->belongsToMany('Xtwoend\Component\User\Entities\Permission')->withTimestamps();
    }
    /**
     * @param $query
     * @param $search
    ...
    {
        return $this->belongsToMany('Xtwoend\Component\User\Entities\User')->withTimestamps();
    }
    /**
     * @param $name
     * @return bool
